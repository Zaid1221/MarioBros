...
public class Hud implements Disposable {
    ...
    public Hud(SpriteBatch sb){
        ...
        Table table = new Table(); //creates the table where all the hud data will be shown
        table.top(); //sets the table to be up top
        table.setFillParent(true); // table is now size of stage

        //sets the font of the lables up top
        ...
        stage.addActor(table); //this adds the table to the screen
    }
